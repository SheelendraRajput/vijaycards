<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">Forms/</span>Bridal Relative Add
    </h4>

    <div class="card mb-4">
        <h5 class="card-header">Bridal Relative</h5>
        <form class="card-body" action="<?php echo base_url();?>bridalrelative/add" method="post"  enctype="multipart/form-data">
            <hr class="my-4 mx-n4" />
            <div class="row g-3 ">
                <div class="col-md-12">
