                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <div class="d-flex align-items-center me-3">
                        <img src="<?php echo base_url();?>admin_assets/img/avatars/4.png" alt="Avatar" class="rounded-circle me-3" width="54" />
                        <div class="card-title mb-0">
                      ...
                      <div class="d-flex flex-wrap gap-4 mb-5 mt-4">
                        ...
                        <div class="d-flex flex-column me-2">
                          ...
                          <ul class="list-unstyled me-2 d-flex align-items-center avatar-group mb-0">
                            ...
                            >
                              <img class="rounded-circle" src="<?php echo base_url();?>admin_assets/img/avatars/5.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              class="avatar avatar-xs pull-up"
                            >
                              <img class="rounded-circle" src="<?php echo base_url();?>admin_assets/img/avatars/12.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              class="avatar avatar-xs pull-up"
                            >
                              <img class="rounded-circle" src="<?php echo base_url();?>admin_assets/img/avatars/6.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              class="avatar avatar-xs pull-up"
                            >
                              <img class="rounded-circle" src="<?php echo base_url();?>admin_assets/img/avatars/14.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              class="avatar avatar-xs pull-up"
                            >
                              <img class="rounded-circle" src="<?php echo base_url();?>admin_assets/img/avatars/10.png" alt="Avatar" />
                            </li>
                          </ul>
                        </div>
                        <div class="d-flex flex-column me-2">
                          ...
                          <div class="timeline-event pb-2">
                            ...
                            <div class="d-flex">
                              <a href="javascript:void(0)" class="me-3">
                                <img
                                  src="<?php echo base_url();?>admin_assets/img/icons/misc/pdf.png"
                                  alt="PDF image"
                                  width="23"
                                  class="me-2"
                                />
                          ...
                          <div class="timeline-event pb-2">
                            ...
                            <div class="d-flex flex-wrap">
                              <div class="avatar me-3">
                                <img src="<?php echo base_url();?>admin_assets/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div>
                          ...
                          <div class="timeline-event pb-0">
                            ...
                            <div class="d-flex align-items-center avatar-group">
                              <div
                                ...
                                title="Vinnie Mostowy"
                              >
                                <img src="<?php echo base_url();?>admin_assets/img/avatars/5.png" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar avatar-sm pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                title="Marrie Patty"
                              >
                                <img src="<?php echo base_url();?>admin_assets/img/avatars/12.png" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar avatar-sm pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                title="Jimmy Jackson"
                              >
                                <img src="<?php echo base_url();?>admin_assets/img/avatars/9.png" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar avatar-sm pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                title="Kristine Gill"
                              >
                                <img src="<?php echo base_url();?>admin_assets/img/avatars/6.png" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar avatar-sm pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                title="Nelson Wilson"
                              >
                                <img src="<?php echo base_url();?>admin_assets/img/avatars/14.png" alt="Avatar" class="rounded-circle" />
                              </div>
                            </div>
                          </div>
                        </li>
