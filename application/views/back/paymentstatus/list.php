<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">List /</span> Payment Status List
    </h4>
        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <?php 
                        $i=1;
                    foreach ($paymentstatus as $view){
                      ?>
                    <tr>
                        <td><?php echo $i;?></td>
                        <td><?php echo $view->moment;?></td>
                        <td><?php echo $view->moment_title;?></td>
    ...
    function myFunction(id) {
        ...
        var r = confirm("Do you want to delete this?");
            ...
            if (r == true)
                ...
                window.location = url + "/paymentstatus/delete/" + id;
