                                ...
                                <div id="navbar" class="collapse navbar-collapse navigation-holder">
                                    ...
                                    <ul class="nav navbar-nav mb-2 mb-lg-0">
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a class="active" href="<?php echo base_url()?>Home/theme1">theme 1</a></li>
                                                <li><a href="<?php echo base_url()?>Home/theme2">theme 2</a></li>
                                                <li><a href="<?php echo base_url()?>Home/theme3">theme 3</a></li>
                                                <li><a href="<?php echo base_url()?>Home/theme4">theme 4</a></li>
                    ...
                    <div class="wpo-hero-items owl-carousel">
                        <div class="wpo-hero-item">
                            <div class="wpo-hero-img">
                                <img src="<?php echo base_url()?>front_assets/images/slider/h1.jpg" alt="">
                        ...
                        <div class="wpo-hero-item">
                            <div class="wpo-hero-img">
                                <img src="<?php echo base_url()?>front_assets/images/slider/h2.jpg" alt="">
                                <div class="wpo-hero-text">
                                    <h2>Affection</h2>
                                </div>
                            </div>
                        ...
                        <div class="wpo-hero-item">
                            <div class="wpo-hero-img">
                                <img src="<?php echo base_url()?>front_assets/images/slider/h3.jpg" alt="">
                                <div class="wpo-hero-text">
                                    <h2>Feelings</h2>
                                </div>
                            </div>
                        ...
                        <div class="wpo-hero-item">
                            <div class="wpo-hero-img">
                                <img src="<?php echo base_url()?>front_assets/images/slider/h4.jpg" alt="">
                                <div class="wpo-hero-text">
                                    <h2>Happy</h2>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="wpo-about-item wow fadeInLeftSlow" data-wow-duration="1500ms">
                                <div class="wpo-about-img">
                                    <img src="<?php echo base_url()?>front_assets/images/about/1.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-12 order-lg-2 order-1">
                            <div class="wpo-about-item wow fadeInRightSlow" data-wow-duration="1800ms">
                                <div class="wpo-about-img">
                                    <img src="<?php echo base_url()?>front_assets/images/about/2.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="wpo-Service-wrap">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-Service-item">
                                <div class="wpo-Service-img">
                                    <img src="<?php echo base_url()?>front_assets/images/service/img-1.jpg" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-Service-item">
                                <div class="wpo-Service-img">
                                    <img src="<?php echo base_url()?>front_assets/images/service/img-2.jpg" alt="">
                                </div>
                                <div class="wpo-Service-text">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-Service-item">
                                <div class="wpo-Service-img">
                                    <img src="<?php echo base_url()?>front_assets/images/service/img-3.jpg" alt="">
                                </div>
                                <div class="wpo-Service-text">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-Service-item">
                                <div class="wpo-Service-img">
                                    <img src="<?php echo base_url()?>front_assets/images/service/img-4.jpg" alt="">
                                </div>
                                <div class="wpo-Service-text">
                    ...
                    <div class="col col-xs-12">
                        <div class="wpo-fun-fact-grids clearfix">
                            <div class="grid">
                                ...
                                <div class="flower"><img src="<?php echo base_url()?>front_assets/images/funfact/1.png" alt=""></div>
                            </div>
                            <div class="grid">
                                <div class="info">
                                ...
                                <div class="flower"><img src="<?php echo base_url()?>front_assets/images/funfact/2.png" alt=""></div>
                            </div>
                            <div class="grid">
                                <div class="info">
                                ...
                                <div class="flower"><img src="<?php echo base_url()?>front_assets/images/funfact/3.png" alt=""></div>
                            </div>
                            <div class="grid">
                                <div class="info">
                        ...
                        <div class="col col-lg-7 wow fadeInLeftSlow" data-wow-duration="1700ms">
                            <div class="slider-for">
                                <div class="testimonial-img">
                                    <img src="<?php echo base_url()?>front_assets/images/testimonial/img-1.jpg" alt="">
                                </div>
                                <div class="testimonial-img">
                                    <img src="<?php echo base_url()?>front_assets/images/testimonial/img-2.jpg" alt="">
                                </div>
                                <div class="testimonial-img">
                                    <img src="<?php echo base_url()?>front_assets/images/testimonial/img-3.jpg" alt="">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="portfolio-grids gallery-container clearfix">
                                <div class="grid wow fadeInUp" data-wow-duration="1000ms">
                                    <div class="img-holder">
                                        <img src="<?php echo base_url()?>front_assets/images/portfolio/1.jpg" alt="">
                                ...
                                <div class="grid wow fadeInUp" data-wow-duration="1300ms">
                                    <div class="img-holder">
                                        <img src="<?php echo base_url()?>front_assets/images/portfolio/2.jpg" alt="">
                                        <div class="portfolio-content">
                                ...
                                <div class="grid wow fadeInUp" data-wow-duration="1600ms">
                                    <div class="img-holder">
                                        <img src="<?php echo base_url()?>front_assets/images/portfolio/4.jpg" alt="">
                                        <div class="portfolio-content">
                                ...
                                <div class="grid wow fadeInUp" data-wow-duration="1900ms">
                                    <div class="img-holder">
                                        <img src="<?php echo base_url()?>front_assets/images/portfolio/3.jpg" alt="">
                                        <div class="portfolio-content">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1000ms">
                                <div class="wpo-team-img">
                                    <img src="<?php echo base_url()?>front_assets/images/team/img-1.jpg" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1200ms">
                                <div class="wpo-team-img">
                                    <img src="<?php echo base_url()?>front_assets/images/team/img-2.jpg" alt="">
                                </div>
                                <div class="wpo-team-text">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1400ms">
                                <div class="wpo-team-img">
                                    <img src="<?php echo base_url()?>front_assets/images/team/img-3.jpg" alt="">
                                </div>
                                <div class="wpo-team-text">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1600ms">
                                <div class="wpo-team-img">
                                    <img src="<?php echo base_url()?>front_assets/images/team/img-4.jpg" alt="">
                                </div>
                                <div class="wpo-team-text">
                    ...
                    <div class="row">
                        <div class="col col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-product-item wow fadeInUp" data-wow-duration="1000ms">
                                <div class="wpo-product-img">
                                    <img src="<?php echo base_url()?>front_assets/images/product/1.jpg" alt="">
                                    <ul>
                        ...
                        <div class="col col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-product-item wow fadeInUp" data-wow-duration="1200ms">
                                <div class="wpo-product-img">
                                    <img src="<?php echo base_url()?>front_assets/images/product/2.jpg" alt="">
                                    <ul>
                                        <li><a href="wishlist.html"><i class="fi flaticon-heart"></i></a></li>
                                        <li><a href="cart.html">Add To Cart</a></li>
                                    </ul>
                        ...
                        <div class="col col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-product-item wow fadeInUp" data-wow-duration="1400ms">
                                <div class="wpo-product-img">
                                    <img src="<?php echo base_url()?>front_assets/images/product/3.jpg" alt="">
                                    <ul>
                                        <li><a href="wishlist.html"><i class="fi flaticon-heart"></i></a></li>
                                        <li><a href="cart.html">Add To Cart</a></li>
                                    </ul>
                        ...
                        <div class="col col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-product-item wow fadeInUp" data-wow-duration="1600ms">
                                <div class="wpo-product-img">
                                    <img src="<?php echo base_url()?>front_assets/images/product/4.jpg" alt="">
                                    <ul>
                                        <li><a href="wishlist.html"><i class="fi flaticon-heart"></i></a></li>
                                        <li><a href="cart.html">Add To Cart</a></li>
                                    </ul>
                ...
                <div class="row align-items-center">
                    <div class="col col-xl-4 col-lg-3 col-md-3 col-12">
                        <div class="contact-img">
                            <img src="<?php echo base_url()?>front_assets/images/contact/img-1.jpg" alt="">
                        </div>
                    </div>
                    <div class="col col-xl-4 col-lg-6 col-md-6 col-12">
                        <div class="wpo-contact-section-wrapper">
                            ...
                            <div class="vector-1">
                                <img src="<?php echo base_url()?>front_assets/images/contact/1.png" alt="">
                            </div>
                            <div class="vector-2">
                                <img src="<?php echo base_url()?>front_assets/images/contact/2.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col col-xl-4 col-lg-3 col-md-3 col-12">
                        <div class="contact-img">
                            <img src="<?php echo base_url()?>front_assets/images/contact/img-2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-pricing-item">
                                ...
                                <div class="shape"><img src="<?php echo base_url()?>front_assets/images/pricing/p-shape.svg" alt=""></div>
